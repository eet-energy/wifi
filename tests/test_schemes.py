...
from wifi.scheme import Scheme, extract_schemes
...
class TestForCell(TestCase):
    ...
    def test_wep_hex(self):
        ...
        for key in hex_keys:
            ...
            self.assertEqual(scheme.options, {"wireless-essid": "SSID", "wireless-key": key})
    ...
    def test_wep_ascii(self):
        ...
        for key in ascii_keys:
            ...
            self.assertEqual(scheme.options, {"wireless-essid": "SSID", "wireless-key": "s:" + key})
